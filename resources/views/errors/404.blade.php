        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-404">
                        <h1>404</h1>
                        <h3>Opps! Üzgünüz Aradığınız Sayfa Bulunamadı.</h3>
                        <p>İsmi veya Link adresinin doğru olduğunu kontrol ederek tekrar deneyiniz.</p>
                        <form action="#" class="search-404">
                            <input type="text" placeholder="Anahtar Kelimeyi Giriniz">
