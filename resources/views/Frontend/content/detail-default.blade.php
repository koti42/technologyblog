...
@section('content')
    ...
    <section class="details-hero-section set-bg" data-setbg="/Frontend/img/details/details-post.jpg">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                ...
                <div class="col-lg-8 p-0">
                    <div class="details-text">
                        ...
                        <div class="dt-comment">
                            ...
                            <div class="dc-item">
                                <div class="dc-pic">
                                    <img src="/Frontend/img/details/comment/comment-1.jpg" alt="">
                                </div>
                                <div class="dc-text">
