...
<body translate="no" data-new-gr-c-s-check-loaded="14.996.0" data-gr-ext-installed="">
...
<svg class="key" style="animation-play-state: running; pointer-events: none;">
    <use href="#key"></use>
</svg>
...
<script id="rendered-js">
    ...
    const grantAccess = () => {
        ...
        heading.textContent = '🎉 Hellooğğ 🎉';
        paragraph.textContent = 'Giriş Başarılı!!!';
