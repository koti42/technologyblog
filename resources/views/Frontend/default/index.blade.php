...
//    $database = "techno_blog";
//    $username = "root";
//    $password = "";
//    // Create connection
//    $conn = mysqli_connect($servername, $username, $password, $database);
//    $sorgu = "select Instagram from social_medias";
//
//
...
//
//
//            $json = file_get_contents($row["Instagram"] . '?__a=1');
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="hs-text">
                        ...
                        <div class="ht-meta">
                            <img src="Frontend/img/hero/meta-pic.jpg" alt="">
                            <ul>
                        ...
                        <div class="trending-slider owl-carousel">
                            <div class="single-trending-item">
                                <div class="trending-item">
                                    <div class="ti-pic">
                                        <img src="Frontend/img/trending/trending-1.jpg" alt="">
                                    </div>
                                    <div class="ti-text">
                                ...
                                <div class="trending-item">
                                    <div class="ti-pic">
                                        <img src="Frontend/img/trending/trending-2.jpg" alt="">
                                    </div>
                                    <div class="ti-text">
                                ...
                                <div class="trending-item">
                                    <div class="ti-pic">
                                        <img src="Frontend/img/trending/trending-3.jpg" alt="">
                                    </div>
                                    <div class="ti-text">
                                        <h6><a href="#">Jalopy developer is making a game where you 'build stuff...</a>
                                        </h6>
                                ...
                                <div class="trending-item">
                                    <div class="ti-pic">
                                        <img src="Frontend/img/trending/trending-4.jpg" alt="">
                                    </div>
                                    <div class="ti-text">
                                        <h6><a href="#">Jalopy developer is making a game where you 'build stuff...</a>
                                        </h6>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="lp-slider owl-carousel">
                    <div class="col-lg-3">
                        <div class="lp-item">
                            <div class="lp-pic set-bg" data-setbg="Frontend/img/latest-preview/lp-1.jpg">
                    ...
                    <div class="col-lg-3">
                        <div class="lp-item">
                            <div class="lp-pic set-bg" data-setbg="Frontend/img/latest-preview/lp-2.jpg">
                                <div class="review-loader">
                                    <div class="loader-circle-wrap">
                                        <div class="loader-circle">
                                            <span class="circle-progress" data-cpid="id" data-cpvalue="75"
                    ...
                    <div class="col-lg-3">
                        <div class="lp-item">
                            <div class="lp-pic set-bg" data-setbg="Frontend/img/latest-preview/lp-3.jpg">
                                <div class="review-loader">
                                    <div class="loader-circle-wrap">
                                        <div class="loader-circle">
                                            <span class="circle-progress" data-cpid="id" data-cpvalue="75"
                    ...
                    <div class="col-lg-3">
                        <div class="lp-item">
                            <div class="lp-pic set-bg" data-setbg="Frontend/img/latest-preview/lp-4.jpg">
                                <div class="review-loader">
                                    <div class="loader-circle-wrap">
                                        <div class="loader-circle">
                                            <span class="circle-progress" data-cpid="id" data-cpvalue="75"
                            ...
                            <div class="tab-pane fade show active" id="tabs-1" role="tabpanel">
                                <div class="row">
                                    <div class="un-slider owl-carousel">
                                        <div class="col-lg-12">
                                            <div class="un-big-item set-bg" data-setbg="Frontend/img/news/news-1.jpg">
                                                <div class="ub-text">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="un-item">
                                                        <div class="un_pic set-bg"
                                                             data-setbg="Frontend/img/news/news-3.jpg">
                                                            <div class="label"><span>Reviews</span></div>
                                                        </div>
                                                        <div class="un_text">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="un-item">
                                                        <div class="un_pic set-bg"
                                                             data-setbg="Frontend/img/news/news-4.jpg">
                                                            <div class="label"><span>Reviews</span></div>
                                                        </div>
                                                        <div class="un_text">
                                                            <h6><a href="#">Downwell and space hulk: tactics are coming
                                                ...
                                                <div class="col-md-4">
                                                    <div class="un-item">
                                                        <div class="un_pic set-bg"
                                                             data-setbg="Frontend/img/news/news-2.jpg">
                                                            <div class="label"><span>Reviews</span></div>
                                                        </div>
                                                        <div class="un_text">
                                                            <h6><a href="#">Downwell and space hulk: tactics are coming
                        ...
                        <div class="social-media">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <span>Instagram</span>
{{--                                    @foreach($data['graphql']['user']['edge_followed_by'] as $follow)--}}
{{--                                        <div class="follow">Takipçi: <?=  $follow;  ?> Kişi</div>--}}
{{--                                    @endforeach--}}
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="row">
                            <div class="vg-slider owl-carousel">
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="vg-item large-vg set-bg"
                                                 data-setbg="Frontend/img/videos/videos-1.jpg">
                                        ...
                                        <div class="col-md-6">
                                            <div class="vg-item large-vg set-bg"
                                                 data-setbg="Frontend/img/videos/videos-2.jpg">
                                                <a href="https://www.youtube.com/watch?v=EzKkl64rRbM"
                                                   class="play-btn video-popup"><i class="fa fa-play"></i></a>
                                                <div class="vg-text">
                                                    <h5>THROUGH THE AGES' FIRST EXPANSION WILL BE RELEASING ON DIGITAL
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="vg-item set-bg" data-setbg="Frontend/img/videos/videos-3.jpg">
                                                <a href="https://www.youtube.com/watch?v=EzKkl64rRbM"
                                                   class="play-btn video-popup"><i class="fa fa-play"></i></a>
                                                <div class="vg-text">
                                        ...
                                        <div class="col-md-4">
                                            <div class="vg-item set-bg" data-setbg="Frontend/img/videos/videos-4.jpg">
                                                <a href="https://www.youtube.com/watch?v=EzKkl64rRbM"
                                                   class="play-btn video-popup"><i class="fa fa-play"></i></a>
                                                <div class="vg-text">
                                                    <h6>THis gam,ing laptop with Gtx 1660 ti and of ram is</h6>
                                        ...
                                        <div class="col-md-4">
                                            <div class="vg-item set-bg" data-setbg="Frontend/img/videos/videos-5.jpg">
                                                <a href="https://www.youtube.com/watch?v=EzKkl64rRbM"
                                                   class="play-btn video-popup"><i class="fa fa-play"></i></a>
                                                <div class="vg-text">
                                                    <h6>THis gam,ing laptop with Gtx 1660 ti and of ram is</h6>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="ip-item">
                        <div class="ip-pic">
                            <img src="Frontend/img/instagram/insta-1.jpg" alt="">
                        </div>
                        <div class="ip-text">
                            <div class="label"><span>Reviews</span></div>
                    ...
                    <div class="ip-item">
                        <div class="ip-pic">
                            <img src="Frontend/img/instagram/insta-2.jpg" alt="">
                        </div>
                        <div class="ip-text">
                    ...
                    <div class="ip-item">
                        <div class="ip-pic">
                            <img src="Frontend/img/instagram/insta-4.jpg" alt="">
                        </div>
                        <div class="ip-text">
                            <div class="label"><span>Playstation</span></div>
                ...
                <div class="col-lg-4 col-md-7">
                    <div class="sidebar-option">
                        <div class="insta-media">
                            ...
                            <div class="insta-pic">
{{--                                @foreach($data['graphql']['user']['edge_owner_to_timeline_media']['edges'] as $da)--}}
{{--                                    @if($sayac<4)--}}
{{--                                        <?php $sayac++; ?>--}}
{{--                                        <img width="175" height="175" src="<?= $da['node']['display_url']?>" alt="">--}}
{{--                                    @endif--}}
{{--                                @endforeach--}}
                            </div>
                        </div>
